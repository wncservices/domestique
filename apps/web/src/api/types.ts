...
export interface Ride {
  ...
  createdBy: string
  /** Set when this ride was generated by a recurring series — see
   *  ScheduleRideSeriesRequest. Absent for an ordinary one-off ride. */
  seriesId?: string
}
...
/** The only recurrence intervals a series accepts — see schedule.Store's
 *  own seriesIntervals. */
export type RideSeriesInterval = 1 | 2 | 4

export interface ScheduleRideSeriesRequest {
  slug: string
  date: string
  time?: string
  intervalWeeks: RideSeriesInterval
